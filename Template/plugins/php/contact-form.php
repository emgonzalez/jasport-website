<?php
$emailTo       = '<emilio.gonzalez@jasportco.com>';
$sender_email = 'no-reply@jasportco.com';
...
$body    = '';
$email = 'no-reply@jasportco.com';
$name = 'Jasport CO';

if($_SERVER['REQUEST_METHOD'] === 'POST') {
    $arr = $_POST['values']; //[email:[value,error],name:[value,error]]
    $sender_email = 'no-reply@jasportco.com' //'no-reply@' . $_POST['domain'];
